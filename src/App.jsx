...
function WhatWhyHowSection() {
  return (
    <section className="wwh-section">
      <div className="wwh-container">
        <header className="wwh-header animate-on-scroll fade-up">
          <span className="wwh-eyebrow">About this project</span>
          <h2 className="wwh-title">Built for clarity. Designed for Pakistan.</h2>
        </header>

        <div className="wwh-body">
          <div className="wwh-item animate-on-scroll fade-up delay-100">
            <span className="wwh-item-label">What it is</span>
            <p className="wwh-item-text">
              An AI-powered decoder for Pakistani utility bills. Upload any LESCO, SNGPL, or WASA bill and get a plain-language breakdown of every charge, hidden fee, and tariff slab.
            </p>
          </div>

          <div className="wwh-item animate-on-scroll fade-up delay-200">
            <span className="wwh-item-label">Why it exists</span>
            <p className="wwh-item-text">
              Pakistani utility bills are deliberately opaque. Fuel Price Adjustments, slab changes, and surcharges pile up without clear explanation. Bill-y exists so you know exactly what you are paying for and how to stop overpaying.
            </p>
          </div>

          <div className="wwh-item animate-on-scroll fade-up delay-300">
            <span className="wwh-item-label">How it works</span>
            <p className="wwh-item-text">
              Your bill image is sent to Gemini 2.5 Flash, which extracts every line item and cross-checks it against official NEPRA tariffs. The Knowledge Base uses RAG with Gemini Embedding-2 to answer questions from real government documents, cited and streamed in real time.
            </p>
          </div>
        </div>

        <div className="wwh-tech animate-on-scroll fade-up">
          <span className="wwh-tech-label">Powered by</span>
          <div className="wwh-tech-list">
            <span>React 19</span>
            <span>Vite 8</span>
            <span>Express 5</span>
            <span>Recharts</span>
        ...
        <footer className="wwh-footer animate-on-scroll fade-up">
          <p>Open source project for <span className="badge-ai-sekho">AI Sekho 2026</span> by Google.</p>
          <a href="https://github.com/Sinnan1/bill-y" target="_blank" rel="noopener noreferrer" className="wwh-github-link">
            ...
            <>
              <div className="hero-container">
                <div className="hero-content">
                  ...
                  <div className="hero-meta animate-entrance stagger-4">
                    No signup required • Takes 5 seconds • 100% free
                  </div>

                  <div className="trusted-by animate-entrance stagger-4">
